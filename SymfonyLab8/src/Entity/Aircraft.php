...
use App\Action\Aircraft\CapitalizeRegistrationAction;
...
#[ApiResource(
    operations: [
        ...
        new Post(
            uriTemplate: '/aircrafts/{id}/capitalize',
            controller: CapitalizeRegistrationAction::class,
            denormalizationContext: ['groups' => ['aircraft:write']],
            normalizationContext: ['groups' => ['aircraft:read']],
            name: 'capitalize_registration'
        )
    ],
    normalizationContext: ['groups' => ['aircraft:read']],
    denormalizationContext: ['groups' => ['aircraft:write']]
